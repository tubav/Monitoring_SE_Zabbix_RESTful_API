...
//---------------This Part starts the Zabbix connection---------------
    ...
    public @ResponseBody Authentication authentication(
		@RequestParam(value="name", required=false, defaultValue="Error") String name) throws JSONException, FileNotFoundException, UnsupportedEncodingException ,IOException {
...
//    		FileInputStream fis = new FileInputStream("/home/ubuntu/gs-rest-service/initial/src/main/java/tubav/properties.xml");
		...
		JSONObject jsonObj=new JSONObject("{\"jsonrpc\":\"2.0\",\"method\":\"user.authenticate\",\"params\":{\"user\":\"Admin\",\"password\":\"zabbix\"},\"auth\": null,\"id\":0}");
		...
		return new Authentication(String.format("None!"));	
	}
