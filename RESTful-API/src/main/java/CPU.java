...
# This defines the structure of the class CPUController.java.
...
public class CPU{
    ...
    public CPU(String hostid, String metricType, String lastvalue, String timestamp) {
	this.hostid = hostid;
